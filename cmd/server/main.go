...
import (
	...
	"flag"
	"fmt"
	"gateway-service/middleware/circuitbreaker"
	"net/http"
	"os"
	"path/filepath"
	"runtime"
	...
	configLoader "gateway-service/config/config-loader"
	"gateway-service/discovery"
	"gateway-service/middleware"
	"gateway-service/proxy"
	"gateway-service/proxy/debug"
	"gateway-service/server"

	_ "net/http/pprof"

	_ "gateway-service/discovery/consul"
	_ "gateway-service/middleware/bbr"
	_ "gateway-service/middleware/cors"
	_ "gateway-service/middleware/logging"
	_ "gateway-service/middleware/rewrite"
	_ "gateway-service/middleware/tracing"
	_ "gateway-service/middleware/transcoder"
...
func init() {
	...
	flag.StringVar(&proxyConfig, "conf", ConfigPath, "config path, eg: -conf config.yaml")
